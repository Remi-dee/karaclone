...
import uploading_img from "../../../public/Images/uploadingImg.png"
import uploaded_img from "../../../public/Images/uploadedImg.png"
    ...
    <div>
        {uploading ? (
          ...
          <div className=" relative w-full h-[100px] flex flex-col justify-center items-center border-2 border-dotted border-gray-200">
            <input type="file" className=" absolute w-full h-full inset-0 opacity-0 cursor-pointer  " />
            <div className="w-6 h-6 flex justify-center items-center rounded-full border border-gray-200">
                <Image src={uploading_img} alt='' className='w-[20px] h-[20px]'/>
            </div>
