...
const SignUpContent = () => {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="w-1/2 h-screen bg-signupBg">
        {content ? (
      ...
      <div className="w-1/2 h-screen bg-white-300">
        <div className="w-[450px] mt-20 mx-auto shadow-lg">
          <div className="w-[400px] mx-auto pt-0">
            <div className="w-[25px] flex justify-center shadow-lg border rounded-md h-[25px]">
              <TiUser className="text-lg" />
            </div>
            <h2 className="font-bold py-2 dark:text-white text-black">
              Choose Account Type
            </h2>
