...
const DetailsContent = () => {
  return (
    <div className="p-0 m-0 box-border bg-white-100">
      <div className="w-full flex justify-start gap-20 items-start">
        <div className="w-[350px] bg-white-100 h-[100vh] shadow-lg">
          ...
          <div className="mx-5">
            ...
            <div className="w-full flex justify-start items-start gap-2 mb-2">
              <div className="flex flex-col items-center justify-center mt-2 gap-1">
                <div className="w-[25px] h-[25px] flex justify-center border-2 border-purple-200 items-center rounded-full text-center bg-primaryBtn text-white font-montserrat">
