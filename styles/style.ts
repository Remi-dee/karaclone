export const styles = {
  ...
  input:
    "w-full text-[black] padingForInput p-[8px_16px_8px_16px]  dark:text-white bg-transparent border border-slate-200 text-sm rounded h-[40px] px-2 outline-none mt-[5px] font-Poppins w-full",
  button:
