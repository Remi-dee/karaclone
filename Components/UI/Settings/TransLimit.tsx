...
function TransLimit() {
  return (
    <div className=" h-full md:h-[200px] flex mt-[24px]  flex-col gap-[24px] bg-[#FFFFFF] w-[100%]  p-[24px] rounded-[8px]">
      ...
      <section className="  justify-between   flex  flex-col md:flex-row content-between  w-full">
        <div className=" inline-flex flex-col justify-between gap-[8px] w-full md:max-w-[45%]  flex-1  ">
        ...
        <div className="  inline-flex flex-col justify-between mt-[1.3rem] md:mt-0  gap-[8px] w-full md:max-w-[45%]  flex-1  ">
          <div className=" flex flex-row justify-between gap-[8px]  w-full  ">
