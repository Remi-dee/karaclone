...
const CustomDropdown: React.FC<DropdownProps> = ({
  ...
  return (
    ...
    >
      <div
        className={` text-[12px] sm:text-xs md:text-[16px] border-[#DCDCDC] p-[2px_6px] sm:p-[4px_12px] md:p-[4px_24px_4px_24px]  flex justify-center items-center content-center rounded-md  text-gray-800 gap-[10px] cursor-pointer ${
