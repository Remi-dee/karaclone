      ...
      <div className="w-full flex justify-center">
        <div className="flex flex-col min-w-[513px] w-[513px] mt-[64px] items-center justify-start gap-[24px] text-center text-2xl text-neutral-black">
          ...
          {filteredWallets?.map((wallet: any) => (
            <div
              key={wallet.id}
              className="w-[513px] rounded-lg mt-[30px] bg-white-100 shadow-lg overflow-hidden flex flex-col items-center justify-start py-8 px-10 box-border max-w-full text-left text-sm text-neutral-color-500"
            >
