    ...
    <div className=" w-full  pb-[1rem]">
      <div className="block lg:flex items-center gap-4">
        <div className="  flex flex-col gap-2 h-full">
          ...
          <div className=" bg-white-100 min-h-[95px] h-[95px]  lg:min-h-[166px] mt-[16px] rounded-xl flex-1 grow flex lg-mb-0  justify-between items-center border border-slate-200  w-full  gap-[16px]">
