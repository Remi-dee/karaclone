  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-start gap-[24px] text-center text-2xl text-neutral-black">
        <div className="md:w-[550px] w-full md:p-[32px_40px_32px_40px] mt-32 h-max d:mh-[326px] gap-[25px] mx-auto rounded-lg bg-white-100 shadow-lg overflow-hidden flex flex-col justify-center items-center py-8 px-[1rem] box-border max-w-full text-left text-sm text-neutral-color-500 ">
          ...
          <div className=" flex text-center  flex-col gap-[12px]">
            <h3 className=" text-[22px] md:text-[32px] text-[#3D3D3D] leadng-[38.4px] font-bold py-2">
              Transaction is Being Processed
            </h3>
            <p className="text-[#7C7C7C] leading-[24px] text-[14px] md:text-[16px] text-center ">
