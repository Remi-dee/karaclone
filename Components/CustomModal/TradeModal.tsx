      ...
      {isModalOpen && (
        ...
        >
          <div
            ...
            className="h-full  max-h-[90vh]  min-h-[360px] "
          >
            <div className="relative p-[32px_40px_32px_40px] bg-[white] overflow-y-auto rounded-md shadow-lg   h-full  max-h-[90vh]  min-h-[360px] flex z-20">
              {children}
              <div
                onClick={closeModalHandler}
